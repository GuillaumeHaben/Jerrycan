...
import { Content, Card, CardItem, Left, Thumbnail, Body, Button, Text, Icon } from 'native-base';
...
class Jerrycan extends Component {
  ...
  constructor(props) {
    super(props);
    this.del = this.props.navigation.state.params.handleDeleteJerrycan();
  }
    ...
    return (
        <Content>
          <Card style={{flex: 0}}>
            ...
            <CardItem>
              <Left style={{flex: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
                <Button iconLeft warning style={{marginTop: 5}} 
